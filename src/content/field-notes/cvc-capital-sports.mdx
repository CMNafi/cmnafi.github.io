...
<div style="margin-top: 4rem; padding: 1.5rem; border: 1px solid rgba(255, 255, 255, 0.08); border-radius: var(--radius-card); background: rgba(255, 255, 255, 0.02); font-family: var(--font-body);">
  <div style="font-family: var(--font-mono); font-size: 11px; text-transform: uppercase; letter-spacing: 0.15em; color: var(--warning-amber); margin-bottom: 1.25rem;">
    // SERIES: THE SPORTS PRIVATE EQUITY CONQUEST
  </div>
  <div style="display: grid; gap: 0.75rem; font-size: 14px; line-height: 1.5;">
    <div style="display: flex; align-items: baseline; gap: 0.5rem;">
      <span style="font-family: var(--font-mono); font-size: 11px; color: var(--muted); min-width: 60px;">PART I</span>
      <a href="/blog/apollo-global-management-sports" style="color: var(--telemetry-green); text-decoration: none; border-bottom: 1px dotted rgba(0, 230, 118, 0.4); font-weight: bold;">
        Apollo Global Management — Atlético de Madrid & the ASC Launch
      </a>
    </div>
    <div style="display: flex; align-items: baseline; gap: 0.5rem;">
      <span style="font-family: var(--font-mono); font-size: 11px; color: var(--muted); min-width: 60px;">PART II</span>
      <a href="/blog/cvc-capital-sports" style="color: var(--telemetry-green); text-decoration: none; border-bottom: 1px dotted rgba(0, 230, 118, 0.4); font-weight: bold;">
        CVC Capital Partners — Formula 1 & the Original PE Playbook
      </a>
    </div>
    <div style="display: flex; align-items: baseline; gap: 0.5rem;">
      <span style="font-family: var(--font-mono); font-size: 11px; color: var(--muted); min-width: 60px;">PART III</span>
      <a href="/blog/liberty-media-sports" style="color: var(--telemetry-green); text-decoration: none; border-bottom: 1px dotted rgba(0, 230, 118, 0.4); font-weight: bold;">
        Liberty Media — The Drive to Survive Era & the MotoGP Bet
      </a>
    </div>
    <div style="display: flex; align-items: baseline; gap: 0.5rem; margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px dashed rgba(255, 255, 255, 0.08);">
      <span style="font-family: var(--font-mono); font-size: 11px; color: var(--warning-amber); min-width: 60px;">RELATED</span>
      <a href="/blog/blackstone-ipl-acquisition" style="color: var(--telemetry-green); text-decoration: none; border-bottom: 1px dotted rgba(0, 230, 118, 0.4); font-weight: bold;">
        Blackstone & the IPL — Cricket Franchise Finance & Evergreen Capital
      </a>
    </div>
  </div>
</div>
