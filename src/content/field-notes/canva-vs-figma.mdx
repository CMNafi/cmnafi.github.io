...
<div style="margin-top: 4rem; padding: 1.5rem; border: 1px solid rgba(255, 255, 255, 0.08); border-radius: var(--radius-card); background: rgba(255, 255, 255, 0.02); font-family: var(--font-body);">
  <div style="font-family: var(--font-mono); font-size: 11px; text-transform: uppercase; letter-spacing: 0.15em; color: var(--warning-amber); margin-bottom: 1rem;">
    // RELATED DEEP DIVES: THE DESIGN ECONOMY
  </div>
  <div style="display: grid; gap: 0.5rem; font-size: 14px;">
    <a href="/blog/canva-vs-figma" style="color: var(--telemetry-green); text-decoration: none; border-bottom: 1px dotted rgba(0, 230, 118, 0.4); font-weight: bold;">
      Canva vs. Figma — The Collaborative Design Empire Battle
    </a>
    <a href="/blog/figma-the-billion-dollar-bet" style="color: var(--telemetry-green); text-decoration: none; border-bottom: 1px dotted rgba(0, 230, 118, 0.4); font-weight: bold;">
      Figma — The Billion Dollar Covered Call Bet
    </a>
  </div>
</div>
