...
- **Net IRR:** The industry's favorite metric — but deeply misleading (more on this below). [Apollo](/blog/apollo-global-management-sports) claims &#126;39% gross IRR since inception. KKR claims &#126;26%. The reality, as the CFA Institute has demonstrated, is that these IRR figures dramatically overstate actual wealth creation due to how IRR interacts with capital call timing.
...
|---|------|------|---------|-----------|--------------|---------------|-----------|
| 21 | CVC Capital Partners V | [CVC](/blog/cvc-capital-sports) | 2005 | €10.7B | &#126;22% | &#126;2.6x | Formula One, Samsonite |
...
This AUM-over-returns dynamic is reshaping the industry. [Blackstone](/blog/blackstone-vs-blackrock) recently closed its latest flagship fund at &#126;$21 billion — below its $30 billion target. [Apollo](/blog/apollo-global-management-sports), Carlyle, and TPG also closed below initial targets. LPs are pushing back, demanding higher DPI and lower fees, and shifting allocation toward smaller, specialist firms with better track records.
